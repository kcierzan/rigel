...
//! rigel-simd: Trait-based SIMD abstraction layer for real-time audio DSP
//!
//! This library provides zero-cost SIMD abstractions that enable writing DSP algorithms
//! once and compiling to optimal SIMD instructions for each platform.
//!
//! # Features
//!
...
// Re-export libm for use in dependent crates
extern crate libm;
...
#[cfg(all(feature = "avx2", not(feature = "avx512"), target_arch = "x86_64"))]
