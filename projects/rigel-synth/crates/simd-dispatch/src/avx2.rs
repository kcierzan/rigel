...
impl SimdBackend for Avx2Backend {
    ...
    fn exp(input: &[f32], output: &mut [f32]) {
        process_unary::<Avx2Vector, _>(input, output, simd::exp::exp, libm::expf);
    }

    #[inline]
    fn log(input: &[f32], output: &mut [f32]) {
        process_unary::<Avx2Vector, _>(input, output, simd::log::log, libm::logf);
    }

    #[inline]
    fn log2(input: &[f32], output: &mut [f32]) {
        process_unary::<Avx2Vector, _>(input, output, simd::log::log2, libm::log2f);
    }

    #[inline]
    fn log10(input: &[f32], output: &mut [f32]) {
        process_unary::<Avx2Vector, _>(input, output, simd::log::log10, libm::log10f);
    }
    ...
    fn sin(input: &[f32], output: &mut [f32]) {
        process_unary::<Avx2Vector, _>(input, output, simd::trig::sin, libm::sinf);
    }

    #[inline]
    fn cos(input: &[f32], output: &mut [f32]) {
        process_unary::<Avx2Vector, _>(input, output, simd::trig::cos, libm::cosf);
    }
    ...
    fn atan(input: &[f32], output: &mut [f32]) {
        process_unary::<Avx2Vector, _>(input, output, simd::atan::atan, libm::atanf);
    }

    #[inline]
    fn atan2(y: &[f32], x: &[f32], output: &mut [f32]) {
        process_binary::<Avx2Vector, _>(y, x, output, simd::atan::atan2, libm::atan2f);
    }
    ...
    fn tanh(input: &[f32], output: &mut [f32]) {
        process_unary::<Avx2Vector, _>(input, output, simd::tanh::tanh, libm::tanhf);
    }
